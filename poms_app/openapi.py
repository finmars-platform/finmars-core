    ...
    return get_schema_view(
        openapi.Info(
            ...
            x_logo={
                ...
                "backgroundColor": "#000",
                "href": f"/{settings.BASE_API_URL}/docs/api/v1/",
            },
        ),
...
def get_account_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/accounts/",
...
def get_portfolio_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/portfolios/",
...
def get_currency_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/currencies/",
...
def get_instrument_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/instruments/",
...
def get_transaction_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/transactions/",
...
def get_counterparty_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/counterparties/",
...
def get_strategy_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/strategies/",
...
def get_report_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/reports/",
...
def get_procedure_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/procedures/",
...
def get_ui_documentation():
    ...
    local_urlpatterns = [
        re_path(
            f"^{settings.BASE_API_URL}/api/v1/ui/",
...
def render_main_page(request):
    context = {"space_code": settings.BASE_API_URL}
