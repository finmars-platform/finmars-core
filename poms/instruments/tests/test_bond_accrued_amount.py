...
from poms.instruments.finmars_quantlib import BondCalculation
...
class TestBond(unittest.TestCase):
    ...
    def test_accrued_amount_start_of_period(self):
        ...
        self.assertAlmostEqual(accrued, 0.0, places=4, msg="Accrued should be 0 at period start")
    ...
    def test_accrued_amount_one_third_period(self):
        ...
        expected = 5.0
        self.assertAlmostEqual(accrued, expected, places=4, msg="Accrued should be 5.0 at one-third")
    ...
    def test_accrued_amount_mid_period(self):
        ...
        expected = 7.5
        self.assertAlmostEqual(accrued, expected, places=4, msg="Accrued should be 7.5 at mid-period")
    ...
    def test_accrued_amount_specific_date(self):
        ...
        expected = 10.0
        self.assertAlmostEqual(accrued, expected, places=4, msg="Accrued should be 10 on May 1")
    ...
    def test_accrued_amount_end_of_period(self):
        ...
        expected = 15.0
        self.assertAlmostEqual(accrued, expected, places=4, msg="Accrued should be 15 at period end")
    ...
    def test_accrued_amount_start_of_second_period(self):
        ...
        accrued = self.bond.accrued_amount(eval_date)
        self.assertAlmostEqual(accrued, 0.0, places=4, msg="Accrued should be 0 at second period start")
    ...
    def test_accrued_amount_mid_second_period(self):
        ...
        # 90/180 = 0.5 of period, so 15 * 0.5 = 7.5
        expected = 7.5
        self.assertAlmostEqual(accrued, expected, places=4, msg="Accrued should be 7.5 in second period mid")
    ...
    def test_accrued_amount_maturity_date(self):
        ...
        expected = 15.0
        self.assertAlmostEqual(accrued, expected, places=4, msg="Accrued should be 15 on maturity")
    ...
    def test_accrued_amount_before_issue(self):
        ...
        accrued = self.bond.accrued_amount(eval_date)
        self.assertAlmostEqual(accrued, 0.0, places=4, msg="Accrued should be 0 before issue")
