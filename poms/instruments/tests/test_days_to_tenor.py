...
from poms.instruments.finmars_quantlib import convert_days_to_tenor
...
class TestDaysToQuantlibPeriod(unittest.TestCase):
    ...
    def test_30e360_every_fourth_week(self):
        ...
        result = convert_days_to_tenor(28, ql.Thirty360(ql.Thirty360.European))
