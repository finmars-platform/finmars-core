...
def _print_all_records(model, arg1, arg2, arg3):
    ...
    for m in model.objects.using("ro_replica").all():
...
def print_users_and_members():
    _print_all_records(User, "default: u.id=", " u.username=", "ro_replica: u.id=")
    _print_all_records(Member, "default: m.id=", " m.username=", "ro_replica: m.id=")
