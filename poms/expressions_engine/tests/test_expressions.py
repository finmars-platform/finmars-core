...
class TestExpressions(BaseTestCase):
    ...
    calc_period_date_formula_data = {"names1": {}, "is_eval": True}

    calc_period_date_expected = {"names1": {}, "names": {}, "is_eval": True, "log": ""}

    def setUp(self):
        super().setUp()
        self.init_test_case()
        self.url = f"/{self.realm_code}/{self.space_code}/api/v1/utils/expression/"
